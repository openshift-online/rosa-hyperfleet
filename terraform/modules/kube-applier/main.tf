...
# Management Cluster. The controller reads ApplyDesire / ReadDesire documents
# from DynamoDB specs tables (read-only + streams) and writes status back to
# DynamoDB status tables (read-write).
#
